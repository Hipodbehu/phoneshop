...
create table if NOT exists orders (
    secureId VARCHAR(254) NOT NULL primary key,
    subtotal FLOAT,
    deliveryPrice FLOAT,
...
create table if NOT exists orderItems (
    ...
    CONSTRAINT FK_orderItems_orderId FOREIGN KEY (orderId) REFERENCES orders (secureId) ON DELETE CASCADE ON UPDATE CASCADE
);
